...
async def start_setup(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not is_setup_complete:
        ...
        # Для вже налаштованих користувачів показуємо привітання і головне меню в одному повідомленні
        ...
        # Відправляємо єдине повідомлення з привітанням та клавіатурою меню
